...
[Watcher]
public sealed class InboundOrderFlowTaskLinkWatcher : WatcherBase<InboundOrder> {
    private readonly IManagerFactory _managerFactory;

    public InboundOrderFlowTaskLinkWatcher(IManagerFactory managerFactory) {
        _managerFactory = managerFactory;
    }

    public override async Task OnUpdatedAsync(InboundOrder from, InboundOrder to, IReader reader) {
        ...
        await scopedManager.Service.UpdateAsync<int, InboundOrder>(to.Id, entity => {
